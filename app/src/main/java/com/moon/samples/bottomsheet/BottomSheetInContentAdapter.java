 ...
 * @author liangjt
 */
public class BottomSheetInContentAdapter extends RecyclerView.Adapter<BottomSheetInContentAdapter.MyViewHolder> implements ItemMoveListener {
    ...
    public BottomSheetInContentAdapter(Activity context, List<MainBody> list, ItemDragListener itemDragListener) {
